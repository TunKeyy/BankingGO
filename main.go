...
import (
	...
	_ "github.com/TunKeyy/BankingGO/doc/statik"
	"github.com/TunKeyy/BankingGO/gapi"
	"github.com/TunKeyy/BankingGO/mail"
...
func main() {
	...
	runTaskProccessor(ctx, waitGroup, config, redisOpt, store)
...
func runGrpcServer(
	...
	waitGroup.Go(func() error {
		<-ctx.Done()
		log.Info().Msg("grateful shutdown gRPC server")
