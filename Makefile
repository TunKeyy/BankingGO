...
mock:
	...
	mockgen -package mockwk -destination worker/mock/distributor.go github.com/TunKeyy/BankingGO/worker TaskDistributor
...
.PHONY: postgres createdb dropdb migrateup migratedown sqlc test server mock proto evans redis new_migration